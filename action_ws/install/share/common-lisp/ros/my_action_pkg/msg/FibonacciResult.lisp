...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_action_pkg-msg:<FibonacciResult> is deprecated: use my_action_pkg-msg:FibonacciResult instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_action_pkg-msg:sequence-val is deprecated.  Use my_action_pkg-msg:sequence instead.")
  (sequence m))
