...
"""autogenerated by genpy from my_action_pkg/PWMOutputActionResult.msg. Do not edit."""
import codecs
import sys
...
class PWMOutputActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "my_action_pkg/PWMOutputActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_action_pkg/PWMOutputResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PWMOutputActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_action_pkg.msg.PWMOutputResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_action_pkg.msg.PWMOutputResult()
