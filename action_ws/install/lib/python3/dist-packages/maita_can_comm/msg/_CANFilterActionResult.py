...
"""autogenerated by genpy from maita_can_comm/CANFilterActionResult.msg. Do not edit."""
import codecs
import sys
...
class CANFilterActionResult(genpy.Message):
  _md5sum = "f36703e2bba97dc4ce276511d2d5da54"
  _type = "maita_can_comm/CANFilterActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','maita_can_comm/CANFilterResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CANFilterActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = maita_can_comm.msg.CANFilterResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = maita_can_comm.msg.CANFilterResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.filter_index,) = _get_struct_B().unpack(str[start:end])
      return self
