...
"""autogenerated by genpy from maita_can_comm/CANConfigActionResult.msg. Do not edit."""
import codecs
import sys
...
class CANConfigActionResult(genpy.Message):
  _md5sum = "be6e01c4aa9df5f3be36c6e38db45d45"
  _type = "maita_can_comm/CANConfigActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','maita_can_comm/CANConfigResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CANConfigActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = maita_can_comm.msg.CANConfigResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = maita_can_comm.msg.CANConfigResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.actual_baudrate
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.actual_baudrate,) = _get_struct_I().unpack(str[start:end])
      return self
