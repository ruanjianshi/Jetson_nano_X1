...
"""autogenerated by genpy from maita_can_comm/CANCommActionResult.msg. Do not edit."""
import codecs
import sys
...
class CANCommActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "maita_can_comm/CANCommActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','maita_can_comm/CANCommResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CANCommActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = maita_can_comm.msg.CANCommResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = maita_can_comm.msg.CANCommResult()
